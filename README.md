...
| 我要做的事 | 看这份 |
| --- | --- |
| **第一次看本项目 / 答辩评委 / 路演听众** | [📄 作品综述 \| 原理 · 创新点 · 结构 · 演示](docs/06-系统集成/作品综述_原理_创新点_结构_演示.md) |
| 改电话号 / WiFi / 后端 IP / PushPlus token | [📄 现场配置速查](docs/06-系统集成/现场配置速查.md) |
| 蜂鸣器响了但微信没收到 PushPlus / 热点 IP 漂了怎么办 | [📄 热点 IP 变动应对流程](docs/06-系统集成/热点IP变动应对流程.md) |
| 看引脚 / 接线 / 灯带 / 蜂鸣器 / V100C 怎么接 | [📄 硬件接线速查](docs/06-系统集成/硬件接线速查.md) |
| 演示前自检 + 讲者脚本 + 现场故障回退预案 | [📄 演示手册](docs/06-系统集成/演示手册.md) |
| **下次演示开机 5 分钟清单**(token / IP / 固件 哪些不用再做)| [📄 演示当天开机流程](docs/06-系统集成/演示当天开机流程.md) |
| WS63 工程每个目录干嘛的 / 核心代码读哪几个文件 | [📄 工程目录结构与核心代码导读](docs/06-系统集成/工程目录结构与核心代码导读.md) |
